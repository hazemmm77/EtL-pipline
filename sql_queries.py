...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY,start_time time NOT NULL,user_id int NOT NULL,level varchar,\
                          song_id varchar,artist_id varchar,session_id varchar,user_agent varchar,location varchar)")

user_table_create = ("CREATE TABLE IF NOT EXISTS users(user_id varchar  PRIMARY KEY, first_name varchar,last_name varchar,gender varchar,\
                     level varchar)")
...
time_table_create = ("CREATE TABLE IF NOT EXISTS time (start_time time PRIMARY KEY,hour varchar,day int,week int,month int,year int,\
                     weekday int)")
